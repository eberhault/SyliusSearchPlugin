...
setup_application:
	...
	(cd ${APP_DIR} && ${COMPOSER} config --no-plugins --json extra.symfony.endpoint '["https://api.github.com/repos/eberhault/symfony-recipes/contents/index.json?ref=flex/master","flex://defaults"]')
